...
void CheckTextureExtensions (void)
{
	...
	if (!texture_ext || COM_CheckParm ("-gl11") )
	{
		...
		bindTexFunc = (BINDTEXFUNCPTR)(void *)GetProcAddress(hInstGL,"glBindTexture");
...
void CheckMultiTextureExtensions(void) 
{
	...
	if (strstr(gl_extensions, "GL_ARB_multitexture ")) 
	{
		...
		qglMTexCoord2fSGIS_ARB		= (lpMTexFUNC)(void *) wglGetProcAddress("glMultiTexCoord2fARB");
		qglSelectTextureSGIS_ARB	= (lpSelTexFUNC)(void *) wglGetProcAddress("glActiveTextureARB");
		gl_mtexable = true;
	...
	if (strstr(gl_extensions, "GL_SGIS_multitexture ")) 
	{
		...
		qglMTexCoord2fSGIS_ARB		= (lpMTexFUNC)(void *) wglGetProcAddress("glMTexCoord2fSGIS");
		qglSelectTextureSGIS_ARB	= (lpSelTexFUNC)(void *) wglGetProcAddress("glSelectTextureSGIS");
		gl_mtexable = true;
...
void VID_InitDIB (HINSTANCE hInstance)
{
	...
	{
		// default: borderless fullscreen at native resolution
		modelist[0].width = GetSystemMetrics(SM_CXSCREEN);
		modelist[0].height = GetSystemMetrics(SM_CYSCREEN);
	}
...
void	VID_Init (unsigned char *palette)
{
	...
	// decide whether to choose windowed or fullscreen
	...
	// use the actual mode dimensions for conwidth/conheight defaults
	...
	// pick a conheight that matches the actual aspect ratio of the selected mode
