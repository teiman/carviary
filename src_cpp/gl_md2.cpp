...
// load the skins
	...
	{
		pinskins = (char *)(void*)((int) pinmodel + LittleLong(pinmodel->ofs_skins));
...
// load triangles
	pintriangles = (md2triangle_t *)(void*)((int) pinmodel + LittleLong(pinmodel->ofs_tris));
	pouttriangles = (md2triangle_t *)(void*)((int) pheader + pheader->ofs_tris);
...
// load the frames
//
	pinframe = (md2frame_t *)(void*) ((int) pinmodel + LittleLong(pinmodel->ofs_frames));
	poutframe = (md2frame_t *)(void*) ((int) pheader + pheader->ofs_frames);
	...
	// load the draw list
	pinglcmd = (int *)(void*) ((int) pinmodel + LittleLong(pinmodel->ofs_glcmds));
	poutglcmd = (int *)(void*) ((int) pheader + pheader->ofs_glcmds);
