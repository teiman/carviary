...
// so we can run on Win 3.1, where there isn't necessarily Winsock)
    ...
    pWSAStartup = (int (__stdcall *)(WORD,LPWSADATA))(void *)GetProcAddress(hInst, "WSAStartup");
    pWSACleanup = (int (__stdcall *)(void))(void *)GetProcAddress(hInst, "WSACleanup");
    pWSAGetLastError = (int (__stdcall *)(void))(void *)GetProcAddress(hInst, "WSAGetLastError");
    psocket = (SOCKET (__stdcall *)(int,int,int))(void *)GetProcAddress(hInst, "socket");
    pioctlsocket = (int (__stdcall *)(SOCKET,long,u_long *))(void *)GetProcAddress(hInst, "ioctlsocket");
    psetsockopt = (int (__stdcall *)(SOCKET,int,int,const char *,int))(void *)GetProcAddress(hInst, "setsockopt");
    precvfrom = (int (__stdcall *)(SOCKET,char *,int,int,sockaddr *,int *))(void *)GetProcAddress(hInst, "recvfrom");
    psendto = (int (__stdcall *)(SOCKET,const char *,int,int,const sockaddr *,int))(void *)GetProcAddress(hInst, "sendto");
    pclosesocket = (int (__stdcall *)(SOCKET))(void *)GetProcAddress(hInst, "closesocket");
    pgethostname = (int (__stdcall *)(char *,int))(void *)GetProcAddress(hInst, "gethostname");
    pgethostbyname = (hostent *(__stdcall *)(const char *))(void *)GetProcAddress(hInst, "gethostbyname");
    pgethostbyaddr = (hostent *(__stdcall *)(const char *,int,int))(void *)GetProcAddress(hInst, "gethostbyaddr");
    pgetsockname = (int (__stdcall *)(SOCKET,sockaddr *,int *))(void *)GetProcAddress(hInst, "getsockname");
