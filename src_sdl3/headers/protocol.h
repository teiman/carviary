...
#define PROTOCOL_RMQ        999     // FitzQuake/RMQ extended protocol
...
#define U_MODEL2    (1<<24) // protocol 999: model index high byte
...
#define SND_LARGESOUND  (1<<3)  // protocol 999: sound index is short
#define SND_LARGEENTITY (1<<4)  // protocol 999: entity is short+byte
...
// FitzQuake/RMQ protocol 999 messages
#define svc_spawnbaseline2      42
#define svc_spawnstatic2        43
#define svc_spawnstaticsound2   44

// Baseline flags (for svc_spawnbaseline2 / svc_spawnstatic2)
