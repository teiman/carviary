...
// load the skins
	...
	{
		pinskins = (char *)(void*)((intptr_t) pinmodel + LittleLong(pinmodel->ofs_skins));
...
// load triangles
	pintriangles = (md2triangle_t *)(void*)((intptr_t) pinmodel + LittleLong(pinmodel->ofs_tris));
	pouttriangles = (md2triangle_t *)(void*)((intptr_t) pheader + pheader->ofs_tris);
...
// load the frames
//
	pinframe = (md2frame_t *)(void*) ((intptr_t) pinmodel + LittleLong(pinmodel->ofs_frames));
	poutframe = (md2frame_t *)(void*) ((intptr_t) pheader + pheader->ofs_frames);
	for (i=0 ; i < numframes ; i++)
	{
		...
		pinframe = (md2frame_t *)(void*) &pinframe->verts[j].v[0];
		poutframe = (md2frame_t *)(void*) &poutframe->verts[j].v[0];
	}
	...
	// load the draw list
	pinglcmd = (int *)(void*) ((intptr_t) pinmodel + LittleLong(pinmodel->ofs_glcmds));
	poutglcmd = (int *)(void*) ((intptr_t) pheader + pheader->ofs_glcmds);
...
void GL_DrawQ2AliasFrame (entity_t *e, md2_t *pheader, int lastpose, int pose, float lerp)
{
	...
	frame1 = (md2frame_t *)((intptr_t) pheader + pheader->ofs_frames + (pheader->framesize * lastpose)); 
	frame2 = (md2frame_t *)((intptr_t) pheader + pheader->ofs_frames + (pheader->framesize * pose)); 
	...
	order = (int *)((intptr_t)pheader + pheader->ofs_glcmds);
